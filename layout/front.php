...
<?php } ?>
	...
	<div id='frontNews'>
		<div id='frontNewsContent'>
				<div id='frontNewsContentImage'>
					<img src="<?php echo $OUTPUT->pix_url('fp/frontPic2', 'theme'); ?>" alt="" />
				</div>
				<div id='frontNewsContentText'>
					<div id='frontNewsContentTextTitle'>2012-13 Units Archived</div>
					In preparation for the 2013-14 academic year, the TEL team have created a set of new course units ready for tutors to review and update.
					<div id='frontNewsContentTextFooter'><button type='submit'>More</button></div>
				</div>
		</div>
		<div id='frontNewsFooter'>
			<div class='frontNewsFooterStory' id='frontNewsFooterStoryActive'><div class='text'>2012-13 Units Archived</div></div>
			<div class='frontNewsFooterStory'><div class='text'>News Item 2</div></div>
			<div class='frontNewsFooterStory'><div class='text'>News Item 3</div></div>
			<div class='frontNewsFooterStory'><div class='text'>News Item 4</div></div>
		</div>
	</div>
	<div id='frontArticles'>
		<div id='frontArticlesContent'>
			<div class='frontArticlesContentItem' id='frontArticlesContentMargin'>
				<img src="<?php echo $OUTPUT->pix_url('fp/browsers', 'theme'); ?>" alt="" />
			</div>
			<div class='frontArticlesContentItem' id='frontArticlesContentMargin'>
				<img src="<?php echo $OUTPUT->pix_url('fp/moodleMobile', 'theme'); ?>" alt="" />
			</div>
			<div class='frontArticlesContentItem'>
				<img src="<?php echo $OUTPUT->pix_url('fp/eportfolio', 'theme'); ?>" alt="" />
			</div>
		</div>
		<div class='frontArticlesFooter'>		
				<div class='frontArticlesTitle' id='frontArticlesContentMargin'>Which browser?</div>
				<div class='frontArticlesTitle' id='frontArticlesContentMargin'>Mobile Moodle</div>
				<div class='frontArticlesTitle'>ePortfolio</div>
		</div>
	</div>
	<div id='frontTips'>
			<div id='frontTipsHeader'>Useful Moodle tip of the month</div>
			<div id='frontTipsContent'>
				<div id='frontTipsTitle'>Did you know...?</div>
				Moodle has over 86,000 registered installs.
				<div id='frontTipsContentFooter'>
					<form action='<?php echo $CFG->wwwroot; ?>/course/view.php?id=73' id='frontTipsContentFooterStudent'><button type='submit'>Student Help</button></form>
					<form action='<?php echo $CFG->wwwroot; ?>/course/view.php?id=74' id='frontTipsContentFooterStaff'><button type='submit' >Staff Help</button></form>
				</div>
			</div>
			...
			<div id='siteLinksWrapper'>
				...
				<div id='siteLinksTitle'>&nbsp;</div>
					...
					<div class='siteLinksSub'>
						...
						<div class='siteItem' id='footerLogo'><a href='http://www.port.ac.uk'><img src="<?php echo $OUTPUT->pix_url('fp/uopLogo', 'theme'); ?>" /></a></div>
					</div>			
				</div>	
		</div>
		</div>
